...
from plot_functions import read_data, plot_barcode_distribution, plot_lineplot, plot_isolated_lineplot, generate_html_report
...
def main():
    ...
    basic_data = read_data(f"{output_path}/tcr_merged_barcode_distribution_table.csv")
    matches_data = read_data(f"{output_path}/tcr_merged_matches_table.csv")
    ...
    all_plots = [plot1, plot2, plot3, plot4, plot5, plot6]
    
    # HTML report
    generate_html_report(all_plots, config=config_file, output_html="report.html")
