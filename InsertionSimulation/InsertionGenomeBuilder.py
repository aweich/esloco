...
@timeit
def generate_reads_based_on_coverage(fasta, read_length_distribution, coverage):
    '''
...
for mean_read_length, coverage in combinations:
    results.append(pool.apply_async(process_combination, args=(mean_read_length, coverage, insertion_numbers, mod_fasta, insertion_dir)))
