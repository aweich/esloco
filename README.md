...
<p align="center">
    <a href="/docs/MeanCountBarplot.png" target="_blank">
        <img src="/docs/MeanCountBarplot.png" alt="Barplot Absolute Numbers" width="300">
    </a>
    <a href="/docs/lineplot.png" target="_blank" style="margin-left: 20px;">
        <img src="/docs/lineplot.png" alt="Barplot Barcode Absolute Numbers" width="300">
    </a>
    <a href="/docs/coverage.png" target="_blank" style="margin-left: 20px;">
        <img src="/docs/coverage.png" alt="Coverage Plot" width="300">
    </a>
</p>
