...
The illustration above demonstrates the workflow of `simcov`, which uses Monte Carlo simulations to estimate DNA sequencing coverage over target regions. The process involves two main steps:
